...
<div class="play" v-show="playlist.length>0">
 ...
 <transition>
   <div class="mini-player" v-show="!fullScreen" @click="open">
     ...
     <div class="control">
       <progress-circle :radius="rad" :percent="percent">
  ...
  <audio :src="currentSong.url" ref="audio" @timeupdate="updateTime" @ended="end" @play="ready" ></audio>
</div>
</template>
